            ...
            <div className={style.container_about_us}>
              ...
              <div>
                ...
                <p>
                  ...
                  los tamaños. Nos dedicamos a proporcionar soluciones
                  integrales para la gestión, comunicación y aprendizaje en
                  entornos educativos.
                </p>
              </div>
            </div>
              ...
              <div className={style.offers}>
                ...
                <div className={style.offers_detail}>
                  ...
                  <p>
                    ...
                    gestión y envío de correos electrónicos relevantes como
                    pagos o inscripciones.
                  </p>
                </div>
              </div>
            </div>
