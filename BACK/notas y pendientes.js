entonces volviendo a mi controller referido a auth0:
...
podrias detallarme mas en profundidad su utilizacion? porque aun tengo dudas de su funcionamiento.

por ejemplo:
saltrounds=10 que indica el numero de rondas del hashing, que quiere decir esto?
const bcrypt = require("bcrypt") para que se utiliza?
onst crypto = require('crypto') tambien, para que se utiliza?

por otro lado no comprendo como se utiliza auth0, es decir como se conecta a la aplicacion o cliente de auth0(no se como llamarlo, al servicio tal vez) o esto se maneja desde el front?